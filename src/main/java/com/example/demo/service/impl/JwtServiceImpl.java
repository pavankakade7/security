...
import com.example.demo.function.TriConsumer;
import com.example.demo.security.JwtConfiguration;
...
public class JwtServiceImpl extends JwtConfiguration implements JwtService {
    ...
    private  final BiFunction<HttpServletRequest,String, Optional<Cookie>> extractCookie = (request,cookiName)->
            Optional.of(stream(request.getCookies() == null ? new Cookie[]{ new Cookie(EMPTY_VALUE,EMPTY_VALUE)} : request.getCookies())
                    .filter(cookie -> Objects.equals(cookiName, cookie.getName()))
                    .findAny())
                    .orElse(empty());
