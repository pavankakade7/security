...
CREATE TABLE IF NOT EXISTS users(
	...
	CONSTRAINT fk_users_created_by FOREIGN KEY (created_at) REFERENCES users (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS confirmations(
	...
	CONSTRAINT fk_confirmations_created_by FOREIGN KEY (created_at) REFERENCES users (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS documents(
	...
	CONSTRAINT fk_documents_created_by FOREIGN KEY(created_at) REFERENCES users (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS roles(
	...
	created_at TIMESTAMP(6) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
	updated_at TIMESTAMP(6) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT fk_roles_created_by FOREIGN KEY (created_by) REFERENCES users (id) MATCH SIMPLE ON UPDATE CASCADE ON UPDATE  DELETE RESTRICT,
	CONSTRAINT fk_roles_updated_by FOREIGN KEY (updated_by) REFERENCES users (id) MATCH SIMPLE ON UPDATE CASCADE ON UPDATE  DELETE RESTRICT
	);
...
CREATE TABLE IF NOT EXISTS user_roles(
	...
	CONSTRAINT fk_user_roles_user_id FOREIGN KEY (user_id) REFERENCES users (id) MATCH SIMPLE ON UPDATE CASCADE ON UPDATE  DELETE RESTRICT,
	CONSTRAINT fk_user_roles_role_id FOREIGN KEY (role_id)  REFERENCES roles (id) MATCH SIMPLE ON UPDATE CASCADE ON UPDATE  DELETE RESTRICT
);
